...
import com.ktfootball.app.UI.Activity.MyFirendActivity;
...
public class UserProfilesFragment extends BaseFragment {
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        currentUserId = PreferenceManager.getDefaultSharedPreferences(getActivity()).getLong(LoginActivity.PRE_CURRENT_USER_ID, 0);
        init();//判断个人页面还是他人页面
        getUserMsg();//网络获取个人信息
    }
        ...
        if (currentUserId == userId) {//个人页面
            ...
            imageViewHeFootprint.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {//他的足迹
                    Intent intent = new Intent(getActivity(), MyBaiDuFootPrintActivity.class);
            ...
            imageViewHeVcr.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {//他的视频
                    Intent intent = new Intent(getActivity(), MyDVActivity.class);
                    intent.putExtra(EXTRA_ME_OR_HE_USER_ID, userId);
                    startActivity(intent);
                }
            });
    ...
    public void doGetPushVideos() {
        ...
        CallServer.getRequestInstance().add((BaseActivity) getActivity(), 0, request, new HttpListener<CommentedVideos>() {
            @Override
            public void onSucceed(int what, com.yolanda.nohttp.rest.Response<CommentedVideos> response) {
                int x = 0;
                if (((BaseActivity)getActivity()).isSuccess(response.get().response)) {
    ...
    public void doPoP(View view) {
        int isJudge = PreferenceManager.getDefaultSharedPreferences(getActivity()).getInt(LoginActivity.PRE_CURRENT_IS_JUSGE, 0);
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.action_judge:
                        startActivity(new Intent(getActivity(), JudgeSeleteActivity.class));
                        break;
...
//                        break;
    ...
    private void showDialog() {
        if (dialog == null) {
            dialog = new SharedDialog((BaseActivity) getActivity(), R.style.transparentFrameWindowStyle);
        ...
        dialog.show();
        ((BaseActivity)getActivity()).dimActivity(dialog, 0.6f);
...
//        oks.show(this);
    ...
    @OnClick(R.id.activity_user_profiles_stardianp)
    public void setStardianp(){
