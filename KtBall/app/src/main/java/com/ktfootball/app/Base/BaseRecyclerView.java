...
public abstract class BaseRecyclerView extends BaseToolBarActivity2 {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) findViewById(com.chongwuzhiwu.frame.R.id.layout_recyclerview_rv);
        refresh = (SwipeRefreshLayout) findViewById(com.chongwuzhiwu.frame.R.id.layout_recyclerview_sr);
