...
public class VcrPathDao extends AbstractDao<VcrPath, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property IsSuccess = new Property(30, Boolean.class, "isSuccess", false, "IS_SUCCESS");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'VCR_PATH' (" + //
                ...
                "'IS_SUCCESS' INTEGER);"); // 30: isSuccess
    }
    ...
    protected void bindValues(SQLiteStatement stmt, VcrPath entity) {
        ...
        if (isSuccess != null) {
            stmt.bindLong(31, isSuccess ? 1l: 0l);
        }
    }
    ...
    public VcrPath readEntity(Cursor cursor, int offset) {
        VcrPath entity = new VcrPath( //
            ...
            cursor.isNull(offset + 30) ? null : cursor.getShort(offset + 30) != 0 // isSuccess
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, VcrPath entity, int offset) {
        ...
        entity.setIsSuccess(cursor.isNull(offset + 30) ? null : cursor.getShort(offset + 30) != 0);
     }
