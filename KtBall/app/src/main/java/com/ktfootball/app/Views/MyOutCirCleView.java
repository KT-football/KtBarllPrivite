...
public class MyOutCirCleView extends View {
    ...
    public MyOutCirCleView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        PathEffect effects = new DashPathEffect(new float[]{4,20},1);
